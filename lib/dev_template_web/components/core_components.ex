defmodule DevTemplateWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DevTemplateWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DevTemplateWeb.Gettext, "errors", msg, opts)
    end
  end
